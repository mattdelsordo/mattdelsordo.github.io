---
layout: post
title:  "History of the Baritone Brasswind Voice"
...
These, however, are *not* euphoniums:
...
Saxhorns are essentially all the same valved brass instrument but with different choral voices, so we have an alto one, a tenor one, a baritone one, a bass one, etc. I say Sax “invented” these, with the air quotes, because basically everyone in Europe was making variants on this theme at the time. The saxhorn-esque design is the logical endpoint of trying to make a bugle of a given pitch with a given number of piston valves. Enough of these were made that we don't call most of them "saxhorns" in everyday speech: a tuba, for instance, is equivalent to a bass saxhorn, a flugelhorn is a soprano saxhorn, and a baritone saxhorn, with a conical bore, is called a euphonium. A baritone saxhorn with a _cylindrical_ bore, on the other hand, is just called a baritone horn. If that sounds confusing, its because it is, and it led to a lot of lawsuits in the mid-1800s.

Today, old ophicleide parts tend to be played by the tuba as the tuba is the closest thing in terms of tone quality and range that orchestras tend to have on staff. However, the true successor to the ophecleide in terms of range, tone color, and musical usage is really the euphonium. Somehow, the euphonium has been relegated to wind and brass bands specifically, and you'll rarely ever see one appear in an orchestra. This is a musical travesty, and composers and orchestra boards alike need to confront their fear and recognize the euphonium as the true heir to the throne of the baritone brasswind voice.
